...
import irregularIRv from '../data/irregularIR';

const verbList = irregularIRv;
function IrregularIR() {
        ...
        {currentVerb && Object.keys(verbList[currentVerb]).map((person) => (
          <div className="conjugation-input" key={person}>
            ...
            <input
              type="text"
              name={person}
              value={userConjugations[person] || ''.toLowerCase()}
